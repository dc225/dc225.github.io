...
presented by [*c0nfus3d*](https://github.com/c0nfus3d)
  ...
  *It is recommended that you bring a laptop or other portable device with [Node.js](https://nodejs.org/en/download/) already pre-installed. ProTip: append node to your system's PATH for easy command line integration. The current version is recommended, currently __v4.4.3__
